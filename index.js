...
app.post('/generate', async (req, res) => {
  try {
    const variantsText = req.body.variants && req.body.variants.length > 0
      ? `Available variants: ${req.body.variants.join(', ')}`
...
Guidelines:
- Description: 2-3 punchy paragraphs. Lead with the biggest benefit. Use power words that drive urgency and confidence (professional-grade, commercial-quality, built to last, trusted by chefs). If variants exist, naturally mention the available sizes/options. Include natural high-volume keywords. End with a subtle call to action.
...
- Search keywords: TWO tiers separated by | symbol. First: 4-5 broad high-volume keywords. Second: 4-5 specific long-tail buyer-intent phrases. Format: "broad1, broad2, broad3 | long-tail1, long-tail2, long-tail3"
